...
sns.lineplot(data=main_hour_df, x="hr", y="casual", label="Casual")
sns.lineplot(data=main_hour_df, x="hr", y="registered", label="Registered")
sns.lineplot(data=main_hour_df, x="hr", y="cnt", label="ALL")
